package com.dev.ksw.termsexamplecode.adapter
...
import com.dev.ksw.termsexamplecode.holder.TermsHolder

class TermsAdapter(private val termsViewModel: TermsViewModel) : ListAdapter<TermsData, TermsHolder>(TermsDataDiffCallback()) {
